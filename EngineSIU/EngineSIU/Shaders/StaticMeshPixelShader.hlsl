...
#else
        float3 LitColor = Lighting(Input.WorldPosition, WorldNormal, Input.WorldViewPosition, DiffuseColor, Material.SpecularColor, Material.SpecularScalar, ShadowMapLight);
