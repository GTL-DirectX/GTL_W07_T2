...
public:
    ...
    void PrepareRenderState(const std::shared_ptr<FEditorViewportClient>& Viewport, EShadowDepthType Type, int32 DSVIndex = 0, EShadowResolutionLevel ShadowResolutionLevel = EShadowResolutionLevel::Medium);
