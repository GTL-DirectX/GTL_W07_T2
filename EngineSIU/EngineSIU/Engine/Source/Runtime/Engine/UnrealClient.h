...
public:
    ...
    TMap<EShadowDepthType, TMap<EShadowResolutionLevel, FShadowDepthStencilRHI>>& GetShadowDepthStencils();
    ...
    void ClearShadowDepthStencil(ID3D11DeviceContext* DeviceContext, EShadowDepthType Type, uint32 DSVIndex, EShadowResolutionLevel ShadowResolutionLevel);
